...
import com.sososeen09.aspeactj.AspectJask
 ...
 * 增量的任务执行
 */
class AspectJTaskIncrementalProcess {
    Project project
    ...
    AspectJTaskIncrementalProcess(Project project, VariantCache variantCache, TransformInvocation transformInvocation) {
    ...
    void proceed() {
        ...
        AspectJask ajxTask = new AspectJask(project)
        ...
        transformInvocation.inputs.each { TransformInput input ->
            input.jarInputs.each { JarInput jarInput ->
                ...
                AspectJask ajxTask1 = new AspectJask(project)
